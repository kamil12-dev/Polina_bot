...
class infobots(commands.Cog):
    ...
    async def bot(self, ctx):
        ...
        info.add_field(name = ":floppy_disk: Моя версия:", value = "`v4.0.2`", inline=False)
        info.add_field(name = "🔗 GitHub:", value = f"[Нажми](https://github.com/kamil12-dev/Polina_bot)", inline = True)
